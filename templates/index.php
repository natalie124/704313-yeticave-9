<section class="promo">
    ...
    <ul class="promo__list">
        ...
        <li class="promo__item promo__item--<?= $category["symbol_code"] ?>">
            <a class="promo__link" href="all-lots.php?cat_id=<?=htmlspecialchars($category["id"]); ?>"><?=htmlspecialchars($category["name"]); ?></a>
        </li>
        <?php endforeach; ?>
    </ul>
</section>
    ...
    <ul class="lots__list">
        ...
        <li class="lots__item lot">
            ...
            <div class="lot__info">
                ...
                <h3 class="lot__title"><a class="text-link" href="lot.php?lot_id=<?=(int)$lot["id"]; ?>"><?=htmlspecialchars($lot["name"]); ?></a></h3>
